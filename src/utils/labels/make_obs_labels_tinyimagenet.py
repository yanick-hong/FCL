"""Generate observed labels for the Tiny-ImageNet CLIP cache."""
...
def main():
    ...
    p.add_argument("--cache_path", default=str(clip_cache("tiny-imagenet-200")))
    p.add_argument("--save_path", default=str(observed_labels_cache("tiny-imagenet-200")))
    ...
    torch.save({"y_obs": y_obs.long(), "s": s.long(), "meta": {"dataset": "Tiny-ImageNet-200", "from_cache": str(Path(a.cache_path).resolve()), "top_outlier_pct": a.top_outlier_pct}}, out)
